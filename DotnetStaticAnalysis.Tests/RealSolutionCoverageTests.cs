...
public class RealSolutionCoverageTests
{
    ...
    public async Task RoslynAnalysisService_ExerciseAllPublicMethods_MaximizeCoverage()
    {
        ...
        var suggestions2 = await service.GetCodeSuggestionsAsync(new DotnetStaticAnalysisMcp.Server.Models.SuggestionAnalysisOptions
        {
            MaxSuggestions = 50,
            MinimumPriority = DotnetStaticAnalysisMcp.Server.Models.SuggestionPriority.High
        });
        Assert.NotNull(suggestions2);

        var fileSuggestions2 = await service.GetFileSuggestionsAsync("another.cs", new DotnetStaticAnalysisMcp.Server.Models.SuggestionAnalysisOptions
        {
            MaxSuggestions = 25,
            MinimumPriority = DotnetStaticAnalysisMcp.Server.Models.SuggestionPriority.Medium
        });
    ...
    public void ProductionModels_ExerciseAllProperties_MaximizeCoverage()
    {
        ...
        var error = new DotnetStaticAnalysisMcp.Server.Models.CompilationError
        {
            Id = "CS0103",
            Message = "Test error",
        ...
        // Test SolutionInfo
        var solutionInfo = new DotnetStaticAnalysisMcp.Server.Models.SolutionInfo
        {
            Name = "TestSolution",
            FilePath = "test.sln",
            ...
            TotalErrors = 5,
            TotalWarnings = 3,
            Projects = new List<DotnetStaticAnalysisMcp.Server.Models.ProjectInfo>()
        };
        ...
        // Test ProjectInfo
        var projectInfo = new DotnetStaticAnalysisMcp.Server.Models.ProjectInfo
        {
            Name = "TestProject",
        ...
        // Test CodeSuggestion
        var suggestion = new DotnetStaticAnalysisMcp.Server.Models.CodeSuggestion
        {
            Id = "IDE0090",
            Title = "Use 'new(...)'",
            Description = "Use target-typed 'new' expression",
            Category = DotnetStaticAnalysisMcp.Server.Models.SuggestionCategory.Modernization,
            Priority = DotnetStaticAnalysisMcp.Server.Models.SuggestionPriority.Medium,
            Impact = DotnetStaticAnalysisMcp.Server.Models.SuggestionImpact.Small,
            FilePath = "test.cs",
            StartLine = 10,
            StartColumn = 5,
            EndLine = 10,
        ...
        Assert.Equal(DotnetStaticAnalysisMcp.Server.Models.SuggestionCategory.Modernization, suggestion.Category);
        Assert.Equal(2, suggestion.Tags.Count);

        // Test SuggestionAnalysisOptions
        var options = new DotnetStaticAnalysisMcp.Server.Models.SuggestionAnalysisOptions
        {
            MaxSuggestions = 75,
            MinimumPriority = DotnetStaticAnalysisMcp.Server.Models.SuggestionPriority.High,
        ...
        options.IncludedCategories.Add(DotnetStaticAnalysisMcp.Server.Models.SuggestionCategory.Performance);
        options.IncludedCategories.Add(DotnetStaticAnalysisMcp.Server.Models.SuggestionCategory.Security);
        
        options.IncludedAnalyzerIds.Add("CA1822");
        options.ExcludedAnalyzerIds.Add("IDE0001");
        
        Assert.Equal(75, options.MaxSuggestions);
        Assert.Equal(DotnetStaticAnalysisMcp.Server.Models.SuggestionPriority.High, options.MinimumPriority);
