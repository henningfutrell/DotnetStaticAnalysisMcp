...
public sealed class LiveMcpServerTests : IDisposable
{
    ...
    public async Task RoslynAnalysisService_LoadMcpSolution_ShouldDetectAllProjects()
    {
        ...
        // Should detect 4 projects: MCP.Tests, DotnetStaticAnalysisMcp.Server, DotnetStaticAnalysisMcp.IntegrationTests, MCP.TestProject
        ...
        Assert.Contains("DotnetStaticAnalysisMcp.Server", projectNames);
        Assert.Contains("DotnetStaticAnalysisMcp.IntegrationTests", projectNames);
